...
layout = html.Div(children=[
    ...
    className="m-2"),
    dcc.Graph(id='live-update-graph1',style={'width': '30vh', 'height': '20vh','display':'inline-block'},
       figure=fig1),   
    dcc.Graph(id='live-update-graph2',style={'width': '30vh', 'height': '20vh','display':'inline-block'},
       figure=fig2), 
    dcc.Graph(id='live-update-graph3',style={'width': '30vh', 'height': '20vh','display':'inline-block'},
       figure=fig3), 
    html.Div(children=''),
    dcc.Graph(id='live-update-graph4',style={'width': '30vh', 'height': '20vh','display':'inline-block'},
       figure=fig4),   
    dcc.Graph(id='live-update-graph5',style={'width': '30vh', 'height': '20vh','display':'inline-block'},
       figure=fig5), 
    dcc.Graph(id='live-update-graph6',style={'width': '30vh', 'height': '20vh','display':'inline-block'},
       figure=fig6), 
    html.Div(children=''),
    dcc.Graph(id='live-update-graph7',style={'width': '30vh', 'height': '20vh','display':'inline-block'},
       figure=fig7),   
    dcc.Graph(id='live-update-graph8',style={'width': '30vh', 'height': '20vh','display':'inline-block'},
       figure=fig8), 
    dcc.Graph(id='live-update-graph9',style={'width': '30vh', 'height': '20vh','display':'inline-block'},
       figure=fig9),        
    html.Div(children=''),              
    dcc.Graph(id='live-update-graph10',style={'width': '30vh', 'height': '20vh','display':'inline-block'},
       figure=fig10),   
    dcc.Graph(id='live-update-graph11',style={'width': '30vh', 'height': '20vh','display':'inline-block'},
       figure=fig11), 
    dcc.Graph(id='live-update-graph12',style={'width': '30vh', 'height': '20vh','display':'inline-block'},
       figure=fig12), 
    dcc.Interval(
